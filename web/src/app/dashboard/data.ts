...
export const stats: Stat[] = [
  ...
  },
  {
    ...
    value: "18",
    subtext: "6 confirmados",
    icon: "📅",
  },
  {
    label: "Consultas esta semana",
    value: "89",
    subtext: "12 procedimentos",
    icon: "🩺",
  },
  {
    label: "Faturamento mensal",
    value: "R$ 12.4k",
    subtext: "+8% vs último mês",
    icon: "💰",
  },
];
...
export const quickActions: QuickAction[] = [
  ...
  },
  {
    ...
    description: "Adicionar responsável",
    icon: UserPlus,
...
export const notifications: Notification[] = [
  {
    ...
    message: "Cheems - João Silva às 09:00",
    time: "5 min",
    type: "info",
    read: false,
  },
  {
    ...
    message: "Pirata precisa vacinar em 15 dias",
    time: "1 hora",
    type: "warning",
    read: false,
  },
  {
    ...
    message: "Florzinha confirmou presença",
    time: "2 horas",
    type: "success",
    read: true,
  },
