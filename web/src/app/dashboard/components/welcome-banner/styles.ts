...
export const welcomeBannerStyles = tv({
  slots: {
    ...
    statBox: 'text-center px-8 py-5 rounded-3xl border-2 min-w-[130px]',
    statBoxToday: 'bg-white border-teal-300',
    statBoxConfirmed: 'bg-emerald-200 border-emerald-400',
    statBoxWaiting: 'bg-amber-200 border-amber-400',
  ...
  variants: {
    statVariant: {
      ...
      confirmed: { statValue: 'text-emerald-900', statLabel: 'text-emerald-700' },
