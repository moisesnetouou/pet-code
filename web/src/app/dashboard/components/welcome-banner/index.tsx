...
import type { StatBoxProps, WelcomeBannerProps } from "./types";
...
export function WelcomeBanner({
  ...
  const waiting =
    waitingCount ?? appointments.filter((a) => a.status === "agendado").length;
    ...
    <div className={w.container()}>
      <div className={w.content()}>
        <div>
          ...
          <p className={w.stats()}>
            Você tem <span className={w.statNumber()}>{total}</span>{" "}
            agendamentos hoje •
