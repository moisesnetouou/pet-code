...
export const timelineStyles = tv({
  slots: {
    container: "border border-slate-200 shadow-sm overflow-hidden",
    ...
    item: "p-4 hover:bg-slate-50 transition-colors flex items-center gap-4 min-w-0",
    itemTime: "text-lg font-bold text-slate-800 w-16 text-center flex-shrink-0",
    itemAvatar:
    ...
    itemBadge: "px-3 py-1 rounded-lg text-xs flex-shrink-0",
    itemActions: "flex items-center gap-3 flex-shrink-0",
    confirmedButton:
      "bg-teal-500 hover:bg-teal-600 text-white rounded-lg gap-1.5",
    cancelButton:
      "border-slate-200 text-slate-500 hover:text-red-600 hover:border-red-200 hover:bg-red-50 rounded-lg gap-1.5",
    confirmedBadge:
      "flex items-center gap-2 px-3 py-1.5 bg-emerald-50 border border-emerald-200 rounded-lg",
    confirmedBadgeIcon: "w-4 h-4 text-emerald-600",
    confirmedBadgeText: "text-sm font-medium text-emerald-700",
    canceledBadge:
      "flex items-center gap-2 px-3 py-1.5 bg-slate-50 border border-slate-200 rounded-lg",
