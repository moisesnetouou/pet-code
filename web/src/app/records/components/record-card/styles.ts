...
export const recordCardStyles = tv({
  slots: {
    ...
    actionsButton: 'text-slate-500 hover:text-slate-700 w-8 h-8 rounded-full flex items-center justify-center hover:bg-slate-100 transition-colors cursor-pointer',
    content: 'space-y-2',
    ...
    diagnosisLabel: 'text-xs font-medium text-slate-600 uppercase tracking-wide mb-2',
