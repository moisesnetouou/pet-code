...
export const tutorCardStyles = tv({
  slots: {
    container: 'bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition-shadow p-5',
    header: 'flex items-start justify-between mb-4',
    avatarContainer: 'w-12 h-12 rounded-full bg-teal-100 flex items-center justify-center',
    ...
    petsLabel: 'text-xs font-medium text-slate-500 uppercase tracking-wide mb-2',
    petTag: 'inline-flex items-center px-2.5 py-1 bg-slate-100 rounded-lg text-xs font-medium text-slate-700',
  },
  variants: {
    status: {
      ativo: {
