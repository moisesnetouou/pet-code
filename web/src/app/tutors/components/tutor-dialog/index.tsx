...
export function TutorDialog({ open, onOpenChange, tutor, onSave, onDelete }: TutorDialogProps) {
      ...
      <DialogContent className="sm:max-w-[500px] bg-white max-h-[90vh] overflow-y-auto">
        ...
        <div className={s.form()}>
          ...
          <div className={s.row()}>
            ...
            <div className={s.field()}>
              <Label htmlFor="phone" className={s.label()}>Telefone *</Label>
              <Input
                id="phone"
          ...
          <div className={s.field()}>
            <Label htmlFor="address" className={s.label()}>Endereço</Label>
            <Input
              id="address"
          ...
          <div className={s.field()}>
            <Label htmlFor="city" className={s.label()}>Cidade</Label>
            <Input
              id="city"
              value={formData.city}
