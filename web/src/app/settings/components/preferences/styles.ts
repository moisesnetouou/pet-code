...
export const preferencesStyles = tv({
  slots: {
    ...
    saveButton: 'bg-teal-500 hover:bg-teal-600 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors',
    section: 'mb-6 last:mb-0',
    sectionTitle: 'text-base font-semibold text-slate-800 mb-4',
    optionRow: 'flex items-center justify-between py-3 border-b border-slate-100 last:border-0',
    optionLabel: '',
