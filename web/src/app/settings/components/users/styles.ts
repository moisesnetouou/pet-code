...
export const usersStyles = tv({
  slots: {
    ...
    addButton: 'text-teal-600 hover:text-teal-700 hover:bg-teal-50 px-3 py-1.5 rounded-lg text-sm font-medium transition-colors',
    table: 'w-full',
    tableHeader: 'text-left text-xs font-medium text-slate-600 uppercase tracking-wide py-3 border-b border-slate-200',
    ...
    userAvatar: 'w-8 h-8 rounded-full bg-teal-100 flex items-center justify-center text-sm font-bold text-teal-700',
    ...
    actionsButton: 'p-1.5 rounded-lg text-slate-400 hover:text-teal-600 hover:bg-teal-50 transition-colors',
  },
})
