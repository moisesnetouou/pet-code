...
export const stockCardStyles = tv({
  slots: {
    container: 'bg-white rounded-xl border border-slate-200 overflow-hidden hover:border-teal-300 transition-colors cursor-pointer',
    imageContainer: 'relative h-40 bg-slate-100',
    image: 'w-full h-full object-cover',
    typeBadge: 'absolute top-2 right-2 px-2 py-1 rounded-md text-xs font-medium',
    content: 'p-4',
