...
const stockTypes: StockType[] = ['MEDICAMENTO', 'RACAO', 'BRINQUEDO', 'VACINA', 'MATERIAL', 'OUTRO']
...
export function StockDialog({ open, onOpenChange, item, onSave, onDelete }: StockDialogProps) {
  ...
  const handleSubmit = () => {
    const defaultImages: Record<StockType, string> = {
      MEDICAMENTO: 'https://images.unsplash.com/photo-1550572017-edd951b55104?w=400&h=400&fit=crop',
      RACAO: 'https://images.unsplash.com/photo-1589924691995-400dc9ecc119?w=400&h=400&fit=crop',
      BRINQUEDO: 'https://images.unsplash.com/photo-1535294435445-d7249524ef2e?w=400&h=400&fit=crop',
      VACINA: 'https://images.unsplash.com/photo-1584308666744-24a5c6f2302f?w=400&h=400&fit=crop',
      MATERIAL: 'https://images.unsplash.com/photo-1584820927498-cfe5211fd8bf?w=400&h=400&fit=crop',
      OUTRO: 'https://images.unsplash.com/photo-1587300003388-59208cc962cb?w=400&h=400&fit=crop',
    }
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="sm:max-w-[500px] bg-white max-h-[90vh] overflow-y-auto">
        ...
        <div className={s.form()}>
          ...
          <div className={s.field()}>
            <Label htmlFor="description" className={s.label()}>Descrição</Label>
            <Input
              id="description"
          ...
          <div className={s.field()}>
            <Label htmlFor="imageUrl" className={s.label()}>URL da Imagem</Label>
            <Input
              id="imageUrl"
          ...
          <div className={s.row()}>
            <div className={s.field()}>
              <Label htmlFor="quantity" className={s.label()}>Quantidade</Label>
              <Input
                id="quantity"
                type="number"
            ...
            <div className={s.field()}>
              <Label htmlFor="unit" className={s.label()}>Unidade</Label>
              <Input
                id="unit"
                value={formData.unit}
          ...
          <div className={s.field()}>
            <Label htmlFor="minQuantity" className={s.label()}>Quantidade Mínima</Label>
            <Input
              id="minQuantity"
              type="number"
